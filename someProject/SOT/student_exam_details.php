    ...
    if (in_array($_FILES["file"]["type"], $allowedFileType)) {
        ...
        for ($i = 1; $i <= $sheetCount; $i++) {
            ...
            if (isset($spreadSheetAry[$i][2])) {
                $subject_code = mysqli_real_escape_string($conn, $spreadSheetAry[$i][2]);
            }
            $grade = "";
            ...
            if (!empty($rollno)) {
                $query = "insert into  student_exam_details_sot(S_roll,S_cgpa,S_subject_code,S_grade,S_sgpa1,S_sgpa2,S_sgpa3,S_sgpa4,S_sgpa5,S_sgpa6,S_sgpa7,S_sgpa8) values(?,?,?,?,?,?,?,?,?,?,?,?)";
...
<body>
    ...
    <div class="outer-container instructions">
        ...
        <ul>
            <li>
                <h3>Row layout:&emsp;&emsp; Roll no. , CGPA , Subject code , Grade , SGPA1 , SGPA2 , SGPA3 , SGPA4 , SGPA5 , SGPA6 , SGPA7 , SGPA8</h3>
            </li>
            <li>
                <h3> Data should start from the first row and first column. No column and row headings </h3>
            </li>
            <li>
                <button type="input" class="btn-submit"><a style="color:white;text-decoration:none;" href="/someProject/Template/Student_exam_details.xlsx">Download spreadsheet template</a></button>
            </li>
        </ul>
    </div>
